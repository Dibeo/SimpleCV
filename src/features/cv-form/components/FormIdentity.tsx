    ...
    <section className="space-y-6">
      ...
      <div className="flex items-center gap-6">
        <div className="relative group shrink-0">
          ...
          <label className="absolute inset-0 flex items-center justify-center bg-black/50 text-white opacity-0 group-hover:opacity-100 cursor-pointer rounded-xl transition-opacity text-[10px] font-bold">
            PHOTO
            <input
              type="file"
              className="hidden"
      ...
      <div className="flex flex-col gap-2">
        <label className="text-xs font-semibold uppercase text-slate-500 flex items-center gap-2">
          <AlignLeft size={14} /> Résumé professionnel
        </label>
        <textarea
          rows={3}
