...
export const CvPreview = () => {
  ...
  return (
    <div className="sticky top-12">
      <div className="w-[210mm] min-h-[297mm] bg-white shadow-2xl origin-top scale-[0.4] md:scale-[0.5] lg:scale-[0.6] xl:scale-[0.75] text-black transition-all overflow-hidden">
